...
})({"k5o4e":[function(require,module,exports) {
...
const loadSearchResults = async function(query) {
    try {
        ...
        state.search.results = {
            results: data.data.recipes.map((rec)=>({
                    id: rec.id,
                    title: rec.title,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./config.js":"k5Hzs","./helpers.js":"hGI1E"}]},["k5o4e","Y4A21"], "Y4A21", "parcelRequire3a11")
